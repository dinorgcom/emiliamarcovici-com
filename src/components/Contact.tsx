      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 relative">
        <div className="grid grid-cols-12 gap-6 md:gap-10">
          ...
          <div className="col-span-12 md:col-span-9">
            <Reveal as="h2" className="font-serif text-5xl md:text-8xl leading-[0.95] tracking-tight mb-12">
              Interested in
              <br />a <span className="italic text-[#ff2e4c]">piece?</span>
            </Reveal>

            <Reveal delay={1} as="p" className="text-lg md:text-xl leading-relaxed text-black/85 max-w-xl mb-12">
              Send a DM to the studio Instagram with the work you have in
              mind — happy to share dimensions, availability and pricing.
              Commissions welcome.
            </Reveal>
            ...
            <Reveal delay={2} className="flex flex-wrap gap-4">
              <a
                ...
                className="group inline-flex items-center gap-3 px-6 py-4 bg-[#0a0a0a] text-[#f4ede0] rounded-full hover:bg-[#ff2e4c] transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center gap-3 px-6 py-4 border border-black/25 rounded-full hover:bg-black hover:text-[#f4ede0] hover:border-black transition-colors"
              >
            ...
            {/* Info cards — clean Warhol grid */}
            <Reveal delay={3} className="mt-20 grid grid-cols-2 md:grid-cols-4 border-t border-black/15">
              {[
